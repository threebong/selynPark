...
public class WaitMemberListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<AdminListMember> list = new AdminService().waitMemberAll(cPage, numPerPage);
		int totalData = new AdminService().waitMemberAllCount();
		...
		if(pageNo==1) {
			...
			pageBar+="<a class=\"page-link\" aria-label=\"Previous\" href='javascript:waitMemberList("+(pageNo-1)+");'><span aria-hidden=\"true\">[이전]</span></a></li>";
		...
		while(!(pageNo>pageEnd||pageNo>totalPage)) {
			if(cPage==pageNo) {
				...
				pageBar+="<li class=\"page-item\"><a class=\"page-link\" href='javascript:waitMemberList("+(pageNo)+");'>"+pageNo+"</a></li>";
			}
			pageNo++;
		}
		...
		if(pageNo>totalPage) {
			...
			pageBar+=" <li class=\"page-item\"><a class=\"page-link\" aria-label=\"Next\" href='javascript:waitMemberList("+(pageNo)+");'><span aria-hidden=\"true\">&raquo;</span></a>\r\n"
					+ "    </li>\r\n"
					+ "  </ul>\r\n"
					+ "</nav>";
		}
