...
public class InsertScheContentServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Schedule sc = Schedule.builder().memberId(memberId).projectNo(projectNo).scheContent(scheContent)
				.scheTitle(scheTitle).schePlace(schePlace).schePlaceName(schePlaceName).scheStartDate(scheStartDate)
