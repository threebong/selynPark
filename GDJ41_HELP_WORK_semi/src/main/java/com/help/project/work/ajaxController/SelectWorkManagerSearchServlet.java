...
//본인업무 조건 선택해서 조회하기 
		...
		if(pageNo==1) {//이전
			...
			pageBar+="<li class=\"page-item\"><a class=\"page-link\"  href='javascript:workMinePaging("+(pageNo-1)+");' aria-label=\"Previous\"><span aria-hidden=\"true\">&laquo;</span></a></li>";
		}
		while(!(pageNo>pageEnd||pageNo>totalPage)) {
			if(cPage==pageNo) {
				pageBar+="<li class=\"page-item\"><a class=\"page-link\" href=\"#\"><span>"+pageNo+"</a></span></li>";	
			}else {
				pageBar+="<li class=\"page-item\"><a class=\"page-link\"  href='javascript:workMinePaging("+(pageNo)+");'>"+pageNo+"</a></li>";
			}
			pageNo++;
		}
		if(pageNo>totalPage) {//다음
			...
			pageBar+="<li class=\"page-item\"><a class=\"page-link\"  href='javascript:workMinePaging("+(pageNo)+");' aria-label=\"Next\">"+"<span aria-hidden=\"true\">&raquo;</span>"+"</a></li>";
		}
		pageBar+="</ul></nav>";
