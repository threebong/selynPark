...
<body>
	<form name="findIdFrm" method = "post" action="<%=request.getContextPath()%>/member/findMemberIdEnd.do" onsubmit="return idValidate();">
		...
		<section class = "form-search">
			<div class = "find-name">
				<label>이름</label>
				<input type="text" name="memberName" class = "memberName" placeholder = "등록한 이름">
			<br>
			</div>
			<div class = "find-phone">
				<label>번호</label>
				<input type="tel" name="memberPhone" class = "memberPhone" placeholder = "휴대폰번호를 '-'없이 입력">
			</div>
			<br>
		</section>
 ...
 <script>
 	const idValidate=()=>{
 		const userName=$("#memberName").val().trim();
